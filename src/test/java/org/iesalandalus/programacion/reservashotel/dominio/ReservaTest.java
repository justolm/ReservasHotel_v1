...
public class ReservaTest {
    ...
    private static final String ERROR_NUMERO_MAXIMO_PERSONAS_RESERVA="ERROR: El n�mero de personas de una reserva no puede superar al m�ximo de personas establecidas para el tipo de habitaci�n reservada.";
